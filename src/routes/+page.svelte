...
<main class="app-layout">
  ...
  <header class="tab-header">
    <div class="tabs-list">
      <!-- Loop through open tabs using Svelte 5 {#each} -->
      <button class="tab active">[new entry]</button>
      <button class="tab">[/notes]</button>
    </div>
  </header>

  <!-- 2. INLINE PROPERTIES PANEL (YAML frontmatter) -->
  <section class="properties-panel">
    <!-- Input fields for Title, Tags, Aliases -->
  </section>

  <!-- 3. FULL WIDTH TEXT EDITOR -->
  ...
  <footer class="bottom-bar">
    ...
    <button class="btn-flat save-btn">save</button>
  </footer>
</main>
