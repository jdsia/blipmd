...
<header class="tab-header">
  ...
  <div class="tab-row-utilities">
    ...
    >
      <span class="bracket">[</span><svg
        ...
        ></path><path d="M18.5 2.5a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4z"
        ></path></svg
  ...
  <!-- Row 2: Note Document Tabs scroll area -->
  <div
    bind:this={scrollContainer}
    class="tab-row-scroll"
    onwheel={handleWheel}
  >
    <div class="tabs-list">
      ...
      {:else}
        <span style="font-family: 'iA Writer Mono', monospace; font-size: 0.85rem; color: var(--color-slate); font-style: italic; opacity: 0.6;">
          No documents open. Press [new.md] or [/search] to open a note.
        </span>
      {/each}
    </div>
  </div>
